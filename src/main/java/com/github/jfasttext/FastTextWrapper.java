...
@Name("std::vector<fasttext::real>") public static class RealVector extends Pointer {
    ...
    @NoOffset @Name("iterator") public static class Iterator extends Pointer {
        ...
        public native @Name("operator++") @ByRef Iterator increment();
        public native @Name("operator==") boolean equals(@ByRef Iterator it);
        public native @Name("operator*") @ByRef float get();
    }
 ...
 */
    @Namespace("FastTextWrapper") @NoOffset public static class FastTextApi extends Pointer {
        ...
        public native @ByVal RealVector getSentenceVector(@StdString BytePointer word);
        public native @ByVal RealVector getSentenceVector(@StdString String word);
